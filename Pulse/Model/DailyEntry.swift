...
enum PulseMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [PulseVersionedSchemaV1.self, PulseVersionedSchemaV110.self]
    }
...
typealias DailyEntry = PulseVersionedSchemaV110.DailyEntry
typealias DailyLogEntry = PulseVersionedSchemaV110.DailyLogEntry
